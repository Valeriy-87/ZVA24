...
namespace PNA_X
{
    public partial class Form4 : Form
    {
        ...
        private void Form4_Load(object sender, EventArgs e)
        {
            ...
            StreamReader sr = new StreamReader("att_et_phase_12.txt");
        ...
        {
            StreamWriter sw = new StreamWriter("att_et_phase_12.txt");
            ...
            sw = new StreamWriter("att_et_phase_21.txt");
        ...
        {
            if ((e.ColumnIndex == 0) && dataGridView1.Rows[e.RowIndex].Cells[e.ColumnIndex].FormattedValue.ToString().Contains('-'))
            {
        ...
        {
            if ((e.ColumnIndex == 0) && dataGridView2.Rows[e.RowIndex].Cells[e.ColumnIndex].FormattedValue.ToString().Contains('-'))
            {
